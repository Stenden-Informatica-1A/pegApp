			...
			else
			{
				cordova.plugins.CordovaMqTTPlugin.subscribe(
				{
					...
					success: function(s)
					{
						...
						document.getElementById("activity").innerHTML +=
							"--> Success: you are subscribed to the topic, " + topicName +
							"<br>"
						...
						cordova.plugins.CordovaMqTTPlugin.listen(topicName, function(
							payload, params, topic, topic_pattern)
						{
			...
			function(ev)
			{
				cordova.plugins.CordovaMqTTPlugin.unsubscribe(
				{
					...
					success: function(s)
					{
						...
						document.getElementById("subscribe").style.display = "block";
						document.getElementById("activity").innerHTML +=
							"--> Success: you are unsubscribed to the topic, " + topicName +
							"<br>"
					},
					error: function(e)
					{
		...
		document.getElementById("publish").addEventListener('touchend', function(ev)
		{
			...
			else
			{
				cordova.plugins.CordovaMqTTPlugin.publish(
				{
					...
					{
						document.getElementById("activity").innerHTML +=
							"--> Success: you have published to the topic, " + topicName +
							"<br>";
					},
					error: function(e)
					{
