...
$(document).ready(function(){
	...
	//get location from smartphone
	navigator.geolocation.getCurrentPosition(onSuccess, onError);
	
	//if succesfull get the right data from the weather api.
	function onSuccess(position) {
		...
		$.getJSON(Query, function (results) {
			...
			var eenheid = document.querySelector('input[name = "eenheid"]:checked').value;
			//$(".test").html(eenheid);
...
=======
		...
		$(".dCond").html("Locatie opvragen mislukt!");
		$(".weatherIcon").html("<img src='img/night/200.png' alt='Error'>");
		$("#aIcon").html("<img src='img/night/200.png' alt='Error'>");
		onSuccess();
>>>>>>> master
